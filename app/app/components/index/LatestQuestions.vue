...
const query = ref('/api/questions?include=politician,answers,topics,user')
</script>
    ...
    <div class="waha-latestQuestions__container mt-8">
        <div class="waha-tabs border-b-2 border-b-primary-950 flex gap-x-2">
            <div
                ...
                v-on:click="activePage = 'questions'; query = '/api/questions?include=politician,answers,topics,user&page=1'"
            >
